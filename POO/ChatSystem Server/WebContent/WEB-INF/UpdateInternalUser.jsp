...
<html>
	<head>
		<meta charset="UTF-8">
		<title>Update Internal User</title>
	</head>
	<body>
		<%! String ip = ""; 
			String username = "";
		...
		if (status.equals("offline")){
			new UsersDatabaseServer().deleteUser(ip, username, URL, "InternalUsers");
			out.println("User has been deleted");
		} else {
			new UsersDatabaseServer().updateUser(ip, username, status, URL, "InternalUsers");
